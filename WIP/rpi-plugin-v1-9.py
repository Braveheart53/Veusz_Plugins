...
CRITICAL FIX: Don't define prefix/suffix as fields - Veusz handles those internally.
Only define custom fields for our plugin-specific options.

Created by: William W. Wallace
Version: 1.9 (Correct Field Definitions)
"""
...
class RPiTKuImportPluginEnhanced(ImportPlugin):
    ...
    def __init__(self):
        ...
        # CRITICAL: Only define CUSTOM fields here
        # prefix, suffix, tags are handled by Veusz automatically
        self.fields = [
            field.FieldBool(
                'convert_timestamp',
    ...
    def doImport(self, params):
        ...
        params contains:
        - filename: file path
        - prefix: prefix from Veusz UI (handled automatically)
        - suffix: suffix from Veusz UI (handled automatically)
        - tags: tags from Veusz UI (handled automatically)
