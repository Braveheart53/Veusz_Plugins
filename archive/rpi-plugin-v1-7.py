...
CRITICAL: Use **kwargs in doImport to accept all Veusz 4.2 parameters.
Veusz passes prefix/suffix both in fields dict AND as separate args.

Created by: William W. Wallace
Version: 1.7 (Proper **kwargs handling)
"""
...
class RPiTKuImportPluginEnhanced(ImportPlugin):
    ...
    def doImport(self, params):
        ...
        CRITICAL: Use params object (Veusz 4.2 standard).
        params.field_results contains all field values.
        params.filename contains the file path.
        """
        try:
            ...
            # Get field values from params.field_results dict
